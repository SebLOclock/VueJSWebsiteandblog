---
title: "Pourquoi elle fait des fautes si elle est intelligente ?"
slug: "pourquoi-elle-fait-des-fautes-si-elle-est-intelligente"
date: "2026-03-10"
...
Je m'en sortais pas trop mal, je trouvais. L'analogie du cerveau qui apprend, les milliards de données, le truc qui génère du texte tout seul... Elle écoutait, elle hochait la tête.
...
J'ai essayé d'expliquer ça à Alice avec d'autres mots. Elle a réfléchi. Puis elle m'a sorti :

> *"Ah donc c'est pas vraiment intelligente, c'est juste qu'elle fait semblant ?"*

Je lui ai dit que c'était à peu près ça, même si c'était un peu plus compliqué.

Elle a haussé les épaules et elle est repartie jouer.

Honnêtement ? C'est exactement la bonne réaction face à un outil qui "fait semblant". L'utiliser, vérifier, passer à autre chose. On devrait tous s'en inspirer.

## Ce que cette question change concrètement

Si vous êtes parent, enseignant, formateur, ou simplement quelqu'un qui utilise des outils IA au quotidien, cette distinction a des conséquences très pratiques.

**Ça change comment on vérifie.** Une faute dans un texte généré par une IA, c'est pas un accident repérable à la relecture rapide. C'est une erreur qui peut être formulée de façon parfaitement fluide, sans aucun signal d'alarme. Le truc faux peut sonner plus "juste" que le truc vrai.

**Ça change comment on en parle aux enfants.** Si on leur dit que c'est "intelligent", ils vont lui faire confiance comme ils feraient confiance à un adulte compétent. Ce n'est pas la bonne posture. La bonne posture, c'est : "c'est un outil très puissant, qui se trompe, et ton boulot c'est de vérifier."

**Ça change comment on l'utilise soi-même.** Poser une question à une IA et copier-coller la réponse sans réfléchir, c'est exactement aussi risqué que de faire confiance à quelqu'un qui parle bien mais qu'on ne connaît pas.
